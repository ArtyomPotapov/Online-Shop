...
//MARK: - этот класс Reachabilty скопирован из другого источника полностью, он отвечает за проверку наличия интернет-соединения через метод func HasConnection(). Это его основная задача. Содержание этого кода требует последующего изучения. Но потом.
